KRK.TYPE.Karaoke = function( layer )
{
// properties
	var self = this ;
	this.$ = null ;
...
KRK.TYPE.Karaoke.assign = function( object , k_object )
{
	object.K = k_object ;
}


KRK.TYPE.Karaoke.prototype.constructor = function( layer )
{
	this.parseLayer( layer ) ;
}

KRK.TYPE.Karaoke.prototype.parseLayer = function( layer )
{
	var content ;
	if ( layer instanceof Object )
	{
		if ( layer.text )
		{
			layer.enabled = false ; // Hides it automatically.
			content = layer.text.sourceText ;
			return ( this.K = this.parse_ass( content ) ) ;
		}
	}
	return null ;
}
 ...
 */
KRK.TYPE.Karaoke.prototype.parse_ass = function( x )
{
	var StyleLayer ;
	var hh , text1 , text3;
	var K = { } ; var k ;
...
KRK.TYPE.Karoake.secs = function( t )
{
	var T = t.split( /:/ ) ;
